...
function HS_calender() {
    ...
    style += ".calender { width:170px; height:auto; font-size:12px;margin:22px 0 0 -75px; background:url(calenderbg.gif) no-repeat right center #fff; border:1px solid #397EAE; padding:1px}";
