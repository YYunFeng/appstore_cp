...
function _MakePWDWidget()
{
	...
	code += "<input type='password' class='ipt1' name='"+pwdname+"' id='"+this.pwdfieldid+"'>";
	...
	code += "<div class='pwdopsdiv' id='"+this.pwdshowdiv+"'><a href='#' id='"+this.pwdshow_anch+"' style='display: none;'>"+this.txtShow+"</a></div>";

	this.pwdgendiv = pwdname+"_gendiv";

	this.pwdgenerate_anch = pwdname + "_gen_anch";

	code += "<div class='pwdopsdiv'id='"+this.pwdgendiv+"'><a href='#' id='"+this.pwdgenerate_anch+"' style='display: none;'>"+this.txtGenerate+"</a></div>";
	...
	code += "<div id='' class='fl'></div><div class='pwdstrengthbar fl' id='"+this.pwdstrengthbar+"'></div>";

	this.pwdstrengthstr = pwdname + "_strength_str";

	code += "<div class='pwdstrengthstr fl' id='"+this.pwdstrengthstr+"'></div>";
